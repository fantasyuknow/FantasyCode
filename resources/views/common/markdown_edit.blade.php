...
<link rel="stylesheet" href="{{ asset('/ext/Simplemde_Markdown/dist/simplemde.min.css') }}">
<script src="{{ asset('/ext/Simplemde_Markdown/dist/simplemde.min.js') }}"></script>
<script src="{{ asset('/ext/InlineAttachment/dist/codemirror-4.inline-attachment.min.js') }}"></script>
<script src="{{ asset('/ext/Simplemde_Markdown/HtmlToMarkdown.js') }}"></script>
